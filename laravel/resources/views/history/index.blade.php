        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            ...
            <div>
                ...
                <p class="text-muted mb-0">
                    ...
                    Seluruh hasil deteksi AI yang pernah dilakukan.
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-4">
                            ...
                            @else
                                ...
                                <div
                                    class="rounded-4 d-flex align-items-center justify-content-center bg-light"
                                    style="height:150px;">
                        ...
                        <div class="col-8">
                            ...
                            <h4 class="fw-bold mb-2">
                                ...
                                {{ $history->category->name ?? 'Tidak Diketahui' }}
...
@else
    ...
    <div class="py-5 text-center">
        ...
        <div
            ...
            style="width:130px;height:130px;background:#f1f5f9;">
        ...
        <p class="text-muted mt-3 mb-4">
            ...
            Anda belum pernah melakukan deteksi sampah menggunakan AI.
